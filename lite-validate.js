$.extend($.fn, {
    lite_validate: function (options) {
        if (!this.length) {
            return ;
        }
        var validator = $.data(this[0], 'lite_validator');
        if (validator) {
            return validator;
        }
        var validator = new lite_validator(options, this);
        $.data(this[0], 'lite_validator', validator);
        return validator;
    },
});
lite_validator = function (options, form) {
    $.extend(this, {
        defaults: {
